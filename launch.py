...
def prepare_environment():
    ...
    commandline_args = os.environ.get('COMMANDLINE_ARGS', "--precision full --lowvram --lowram --no-half --no-half-vae --xformers --skip-torch-cuda-test --listen --disable-console-progressbars --enable-console-prompts --no-progressbar-hiding --autolaunch --opt-sdp-attention")

    gfpgan_package = os.environ.get('GFPGAN_PACKAGE', "git+https://github.com/TencentARC/GFPGAN.git@8d2447a2d918f8eba5a4a01463fd48e45126a379")
    clip_package = os.environ.get('CLIP_PACKAGE', "git+https://github.com/openai/CLIP.git@d50d76daa670286dd6cacf3bcd80b5e4823fc8e1")
    openclip_package = os.environ.get('OPENCLIP_PACKAGE', "git+https://github.com/mlfoundations/open_clip.git@bb6e834e9c70d9c27d0dc3ecedeebeaeb1ffad6b")

    xformers_windows_package = os.environ.get('XFORMERS_WINDOWS_PACKAGE', 'https://github.com/camenduru/stable-diffusion-webui-colab/releases/download/0.0.16/xformers-0.0.16+814314d.d20230118-cp310-cp310-linux_x86_64.whl')
    ...
    stable_diffusion_xl_repo = os.environ.get('STABLE_DIFFUSION_XL_REPO', "https://github.com/HDRJ-One/generative-models/")
    ...
    git_clone(assets_repo, repo_dir('stable-diffusion-webui-assets'), "assets")
