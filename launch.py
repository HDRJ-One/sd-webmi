...
def prepare_environment():
    ...
    commandline_args = os.environ.get('COMMANDLINE_ARGS', "--precision full --no-half --no-half-vae --xformers --skip-torch-cuda-test --listen --disable-console-progressbars --enable-console-prompts --no-progressbar-hiding --autolaunch --opt-sdp-attention")
